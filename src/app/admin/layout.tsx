  ...
  return (
    <div>
      <div className="mb-6 flex flex-wrap items-center gap-3 border-b border-slate-200 pb-3 text-sm">
        ...
        <Link href="/admin/slot" className="hover:text-emerald-700">Slot</Link>
        <Link href="/admin/prenotazioni" className="hover:text-emerald-700">Prenotazioni</Link>
        <Link href="/admin/utenti" className="hover:text-emerald-700">Utenti</Link>
      </div>
      {children}
    </div>
  );
